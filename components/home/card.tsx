...
export default function Card() {
  return (
    <section className="text-gray-600 body-font overflow-hidden w-full px-4 py-16">
      <div className="mx-auto flex flex-wrap border rounded-lg lg:bg-gradient-to-r from-40% via-sky-100 to-pink-50">
        <div className="lg:w-1/2 w-full px-4 sm:px-8 md:px-12 lg:px-20 py-10 md:py-16 items-center justify-center">
