      ...
      <section className="py-24 pt-32">
        <div className="container mx-auto px-4 relative">
          ...
          <p className="text-xl mb-8">
            This Privacy Policy is provided on behalf of Legal Action, developed
            by Urbandwell Technologies, hereinafter referred to as "we," "us,"
            or "our." This policy outlines how we collect, use, and share user
            data in connection with the use of our mobile application available
