export const testimonials = [
  {
    content:
      "I cannot recommend Bereej Tech enough! Their team went above and beyond to understand our unique business needs and delivered a custom software solution that has streamlined our operations and boosted productivity.",
    author: "Digambar AhirRao",
    initials: "DA",
    image: "/images/dummy-man.png",
  },
  {
    content:
      "I'm thrilled with Bereej Tech's services! Their team's in-depth understanding of our industry allowed them to create a software solution that not only met but exceeded our demands, resulting in improved efficiency and growth.",
    author: "Irene Samuel",
    initials: "IS",
    image: "/images/dummy-man.png",
  },
