...
export default function AssociatePolicy() {
  return (
      ...
      <section className="py-24 pt-32">
        <div className="container mx-auto px-4 relative">
          ...
          <p className="text-xl mb-8">
            This Privacy Policy is provided on behalf of Associate Legal,
            developed by Urbandwell Technologies, hereinafter referred to as
            ...
            <br />
            <br />
            Images:The app may use images from your device for setting profile
            pictures in your user account and for sharing in other
            functionalities.
            <br />
            <br />
            Sharing of User Data:Personal and sensitive user data, such as
            contact information and images, may be shared within the app for the
            intended purpose of enabling communication features. We do not share
            this data with any third parties.
            <br />
            <br />
            Security:We implement industry-standard security measures to protect
            the data collected from unauthorized access, disclosure, alteration,
            and destruction.
            <br />
            <br />
            ...
            <br />
            <br />
            Data Retention:We retain user data only for as long as necessary to
            provide the services outlined in this Privacy Policy. Users have the
            right to request the deletion of their data from our servers.Your
            Consent:By using the the app, you consent to the terms outlined in
            this Privacy Policy.
            <br />
            <br />
            Updates to Privacy Policy:We reserve the right to update this
            Privacy Policy from time to time. Any changes will be effective upon
            posting the revised policy. We will notify users of significant
            changes via the app or other means.
            <br />
            <br />
            Accessibility:This Privacy Policy is accessible through a standard
            web browser without the need for plugins or special handlers. It is
