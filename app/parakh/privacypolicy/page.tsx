...
export default function ParakhPolicy() {
  return (
      ...
      <section className="py-24 pt-32">
        <div className="container mx-auto px-4 relative">
          ...
          <p className="text-xl mb-8">
            ...
            This Privacy Policy is provided on behalf of परख, developed by
            Maharashtra State Transmission Company Limited with technology
            partner M/s Bereej Technologies Private Limited Pune, here in after
            referred to as "we," "us," or "our." This policy outlines how we
            collect, use, and share user data in connection with the use of our
            mobile application available on the Google Play Store. <br />
            <br />
            ...
            =E2=80=9CWebsite =E2=80=9D (defined below). &nbsp;
            <br />
            <br />
            ...
            and transfer of sensitive personal data or information. <br />
            <br />
            ...
            is committed to protecting the privacy of its users. This Privacy
            ...
            <br />
            =E2=80=8D<strong>SMS Functionality</strong>: Our app utilizes the
            device's SMS feature to send user credentials (user ID and password)
            to designated recipients. By using this feature, you consent to the
            app accessing and sending SMS messages from your device.=E2=80=8B{" "}
            <br />
            =E2=80=8D<strong>Identification Documents</strong>: During user
            registration, we may request image s of identification documents,
            such as Aadhaar cards and PAN cards, to verify your identity. By
            providing these images, you consent to their use for identification
            purposes within the app. <br />
            =E2=80=8D
            ...
            <br />
            =E2=80=8D<strong>Data Retention</strong>:We retain user data only
            for as long as necessary to provide the services outlined in this
            Privacy Policy. Users have the right to request the deletion of
            their data from our servers.Your Consent:By using the the app, you
            consent to the terms outlined in this Privacy Policy. <br />
            =E2=80=8D<strong>Updates to Privacy Policy</strong>
            ...
            We will notify users of significant changes via the app or other
            means. <br />
            =E2=80=8D<strong>Accessibility</strong>:This Privacy Policy is
            accessible through a standard web browser without the need for
            plugins or special handlers. It is available on our website which is
            publicly accessible and not geofenced. By using the tapp, you agree
